...
<template>
  ...
  >
    <HeroSectionSmall headline="IMPRESSUM" description="Angaben gemäß § 5 TMG" />
        ...
        <div class="space-y-12">
          ...
          <div>
            ...
            <div class="mt-4 space-y-1 font-body text-lg leading-relaxed text-vsg-blue-700">
              <p>
                <strong class="text-vsg-blue-900">Rechtsform:</strong> eingetragener Verein (e.V.)
              </p>
          ...
          <div>
            ...
            <div class="mt-4 space-y-1 font-body text-lg text-vsg-blue-700">
              <p>
                <strong class="text-vsg-blue-900">Registergericht:</strong> Registergericht Stendal
              </p>
            ...
            <div class="mt-4 space-y-6 font-body text-lg leading-relaxed text-vsg-blue-700">
              <div>
                ...
                <p>
                  ...
                  Informationen verursacht wurden, sind grundsätzlich ausgeschlossen, sofern seitens
                  des Autors kein nachweislich vorsätzliches oder grob fahrlässiges Verschulden
                  vorliegt. Alle Angebote sind freibleibend und unverbindlich. Der Autor behält es
              ...
              <div>
                ...
                <p>
                  ...
                  sind! Das Copyright für veröffentlichte, vom Autor selbst erstellte Objekte bleibt
