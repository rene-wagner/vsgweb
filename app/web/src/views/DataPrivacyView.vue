...
<template>
  ...
  >
    <HeroSectionSmall headline="DATENSCHUTZ" description="Datenschutzerklärung gemäß DSGVO" />
        ...
        <div class="space-y-12">
            ...
            <div class="mt-4 space-y-6 font-body text-lg leading-relaxed text-vsg-blue-700">
              <div>
                ...
                <p>
                  ...
                  auf unseren Seiten personenbezogene Daten (wie Name, Anschrift oder
                  E-Mail-Adresse) erhoben werden, erfolgt dies, soweit möglich, auf freiwilliger
                ...
                <p class="mt-2">
                  ...
                  erheben und verwenden wir personenbezogene Daten von Ihnen, soweit dies zu diesen
                  Zwecken erforderlich ist (Bestandsdaten). Sämtliche personenbezogenen Daten werden
                  nur solange gespeichert wie dies für den genannten Zweck (Bearbeitung Ihrer
                  Anfrage oder Abwicklung eines Vertrags) erforderlich ist. Hierbei werden steuer-
                  und handelsrechtliche Aufbewahrungsfristen berücksichtigt.
                </p>
                <p class="mt-2">
                  Wir weisen ausdrücklich darauf hin, dass die Datenübertragung im Internet (z.B.
                  bei der Kommunikation per E-Mail) Sicherheitslücken aufweisen kann und nicht
                  lückenlos vor dem Zugriff durch Dritte geschützt werden kann. Die Verwendung der
                  Kontaktdaten unseres Impressums zur gewerblichen Werbung ist ausdrücklich nicht
                  erwünscht, es sei denn wir hatten zuvor unsere schriftliche Einwilligung erteilt
              ...
              <div>
                ...
                <p>
                  Die Nutzung der dem Verein zur Verfügung gestellten personenbezogenen Daten der
                  Vereinsmitglieder — wie Name, Vorname, Geburtsdatum, Anschrift, Kontoverbindung,
                  Mailadresse und Telefonnummer sowie von Bildmaterial, welches im Rahmen von
                  Vereinsveranstaltungen entstanden ist — erfolgt ausschließlich auf der Grundlage
                  der Datenschutzgrundverordnung (DSGVO) und des Bundesdatenschutzgesetzes (BDSG).
                </p>
                <p class="mt-2">
                  Diese Daten dienen der Erfüllung von Vereinspflichten auf Grundlage der
                  Vereinssatzung (u.a. Einzug von Beiträgen, Mitteilung von Terminen für
                  Vereinsveranstaltungen) und gegenüber behördlicher Institutionen wie dem
                  Landessportbund, Kreissportbund, den Sportfachverbänden (Tischtennis, Volleyball,
                  Gymnastik und Badminton), der Verwaltung des Landkreises und der Stadt Weißenfels
                  sowie dem Finanzamt. Hier werden die Daten z.B. im Zusammenhang mit der
                  Sportstättennutzung, der Höhe von Mitgliedsbeiträgen, der Beantragung und
                  Abrechnung von Fördermitteln und der Abgabe der Körperschaftssteuererklärung
                  benötigt. Sie dienen darüber hinaus, insbesondere in Bezug auf Inhalte unserer
                  Homepage, als Kommunikationsmittel innerhalb und außerhalb des Vereins.
                </p>
                <p class="mt-2">
                  Auf Anordnung der zuständigen Stellen dürfen wir im Einzelfall Auskunft über diese
                  Daten (Bestandsdaten) erteilen, soweit dies für Zwecke der Strafverfolgung, zur
          ...
          <div>
            ...
            <div class="mt-4 space-y-4 font-body text-lg leading-relaxed text-vsg-blue-700">
              ...
              <ul class="list-inside list-disc space-y-2 pl-4">
                <li>
                  Informationspflichten bei der Erhebung von personenbezogenen Daten (Art. 13 und 14
                  DSGVO)
                </li>
                ...
                <li>
                  Mitteilungspflicht in Bezug auf die Berichtigung, Löschung oder Einschränkung der
              ...
              <p>
                Für die Ausübung und Nachfragen hinsichtlich dieser Rechte steht Ihnen der
                Ansprechpartner des Vereins gern zur Verfügung:
              </p>
              <p>
                Christian Köhler<br />
                <strong class="text-vsg-blue-900">E-Mail:</strong>
          ...
          <div>
            ...
            <div class="mt-4 space-y-4 font-body text-lg leading-relaxed text-vsg-blue-700">
              ...
              <p>
                Wir haben die IP-Anonymisierung aktiviert. Auf dieser Webseite wird Ihre IP-Adresse
                von Google daher innerhalb von Mitgliedstaaten der Europäischen Union oder in
