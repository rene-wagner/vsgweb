...
<template>
  ...
  >
    <div class="mt-16 grid gap-6 lg:grid-cols-[1.4fr_0.9fr]">
      <div
        class="rounded-3xl border border-vsg-gold-400/20 bg-linear-to-br from-vsg-blue-900 via-vsg-blue-800 to-vsg-blue-900 p-8 text-white shadow-2xl"
      >
      ...
      <div class="grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
        <div class="rounded-3xl border border-vsg-blue-100 bg-vsg-blue-50 p-6 shadow-sm">
